...
class SelectActivitySurveyRepositoryImpl @Inject constructor(
    ...
    override suspend fun getSelectActivityQuestion(
        surveyId: Int,
        subjectId: Int,
        sectionId: Int,
        referenceId: String,
        ...
        val questionUiList = ArrayList<SelectActivityOptionUiModel>()
        ...
        questionDao.getSurveySectionQuestionForLanguage(
            ...
            val questionUiModel = SelectActivityOptionUiModel(
                ...
                subtitle = TaskCardModel(label = "Label", value = "SubTitle", icon = null),
                subtitle1 = TaskCardModel(label = "Label1", value = "SubTitle 1", icon = null)
            )
