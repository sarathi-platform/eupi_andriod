...
object MigrationQueries {
    ...
    val ALTER_ASSET_JOURNAL_ENTITY_ADD_LOCAL_TRANSACTION_ID =
        "ALTER TABLE $ASSET_JOURNAL_TABLE_NAME ADD COLUMN localTransactionId TEXT"

    val ALTER_MONEY_JOURNAL_ENTITY_ADD_LOCAL_TRANSACTION_ID =
        "ALTER TABLE $MONEY_JOURNAL_TABLE_NAME ADD COLUMN localTransactionId TEXT"

    val ALTER_SUBJECT_LIVELIHOOD_EVENT_MAPPING_ENTITY_ADD_LOCAL_TRANSACTION_ID =
        "ALTER TABLE $SUBJECT_LIVELIHOOD_EVENT_MAPPING_TABLE_NAME ADD COLUMN localTransactionId TEXT"
}