...
//    @Query("SELECT subject_table.userId, subject_table.subjectId, subject_table.subjectName, subject_table.dadaName, subject_table.cohortId, subject_table.cohortName, subject_table.houseNo, subject_table.villageId, subject_table.villageName, subject_table.crpImageLocalPath, subject_table.voName, subject_livelihood_mapping_table.primaryLivelihoodId, subject_livelihood_mapping_table.secondaryLivelihoodId from subject_table join subject_livelihood_mapping_table on subject_table.subjectId = subject_livelihood_mapping_table.subjectId where subject_table.userId = :userId and subject_livelihood_mapping_table.userId = userId")
