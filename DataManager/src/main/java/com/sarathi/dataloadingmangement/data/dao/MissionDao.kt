...
interface MissionDao {
    ...
    @Query("SELECT * FROM $MISSION_TABLE_NAME where userId=:userId and missionId = :missionId and isActive=1")
    suspend fun getActiveMissions(userId: String, missionId: Int): List<MissionEntity>
