...
interface ActivityLanguageDao {
    ...
    @Query(
        "select mission_language_table.description as missionName , activity_language_attribute_table.description as activityName ,mission_livelihood_config_table.livelihoodOrder as livelihoodOrder,mission_livelihood_config_table.livelihoodType as livelihoodType " +
