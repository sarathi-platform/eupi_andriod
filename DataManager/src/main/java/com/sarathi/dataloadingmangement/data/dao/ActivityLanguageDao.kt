...
interface ActivityLanguageDao {
    ...
    @Query(
        "select mission_language_table.description as missionName , activity_language_attribute_table.description as activityName ,livelihood_config_table.livelihoodOrder as livelihoodOrder,livelihood_config_table.livelihoodType as livelihoodType " +
                "from $ACTIVITY_LANGUAGE_ATTRIBUTE_TABLE_NAME" +
                " left join livelihood_config_table on activity_language_attribute_table.missionId=livelihood_config_table.missionId and livelihood_config_table.userId=:userId and livelihood_config_table.languageCode=:languageCode " +
