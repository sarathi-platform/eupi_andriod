...
class MissionViewModel @Inject constructor(
    ...
    private val missionList: State<List<MissionResponseModel>> get() = _missionList
    private val _filterMissionList = mutableStateOf<List<MissionResponseModel>>(emptyList())

    val filterMissionList: State<List<MissionResponseModel>> get() = _filterMissionList
    ...
    private fun initMissionScreenList() {
        CoroutineScope(Dispatchers.IO + exceptionHandler).launch {
            missionScreenUseCase.getMissionsUseCase.invoke()?.let {
    ...
    override fun performSearchQuery(
        ...
        val filteredList = ArrayList<MissionResponseModel>()
