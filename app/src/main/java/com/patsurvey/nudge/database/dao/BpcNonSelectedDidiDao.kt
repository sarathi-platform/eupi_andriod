...
interface BpcNonSelectedDidiDao {
    ...
    @Query("UPDATE $BPC_NON_SELECTED_DIDI_TABLE set patSurveyStatus = :patSurveyStatus,section1Status=:section1Status,section2Status=:section2Status,needsToPostPAT=0,shgFlag=:shgFlag,patExclusionStatus=:patExclusionStatus WHERE id =:didiId")
    ...
    @Query("UPDATE $BPC_NON_SELECTED_DIDI_TABLE SET localPath = :localPath WHERE id = :didiId")
