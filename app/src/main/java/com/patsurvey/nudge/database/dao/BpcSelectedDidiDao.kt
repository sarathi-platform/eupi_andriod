...
interface BpcSelectedDidiDao {
    ...
    @Query("UPDATE $BPC_SELECTED_DIDI_TABLE set patSurveyStatus = :patSurveyStatus,section1Status=:section1Status,section2Status=:section2Status,needsToPostPAT=0,shgFlag=:shgFlag WHERE id =:didiId")
