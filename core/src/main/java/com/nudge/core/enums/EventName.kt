...
enum class EventName(val id: Int, val depends_on: List<Int> = emptyList(), val topicName: String) {
    ...
    SAVE_WEALTH_RANKING(7, listOf(4), "BENEFICIARY_EDIT_TOPIC"),
    SAVE_PAT_ANSWERS(8, listOf(4, 7), topicName = "PAT_SAVE_TOPIC"),
    SAVE_PAT_SCORE(9, listOf(4, 7), topicName = "BENEFICIARY_EDIT_TOPIC"),
    SAVE_VO_ENDORSEMENT(10, listOf(4, 7, 9), topicName = "BENEFICIARY_EDIT_TOPIC"),
    UPLOAD_DIDI_IMAGE(11, listOf(4), topicName = "UPLOAD_DIDI_IMAGE"),
    UPLOAD_FORM_IMAGE(12, listOf(10), topicName = "UPLOAD_FORM_IMAGE"),

    SAVE_BPC_MATCH_SCORE(13, emptyList(), topicName = "BPC_SAVE_MISMATCH_TOPIC"),
