...
enum class EventName(val id: Int, val depends_on: List<Int> = emptyList(), val topicName: String) {
    ...
    LIVELIHOOD_OPTIONS_EVENT(37, topicName = "LIVELIHOOD_OPTIONS_TOPIC"),
    MONEY_JOURNAL_RESPONSE_EVENT(37, topicName = "MONEY_JOURNAL_TOPIC"),
    ASSET_JOURNAL_EVENT(38, topicName = "ASSET_JOURNAL_TOPIC"),
    LIVELIHOOD_EVENT(39, topicName = "LIVELIHOOD_EVENT_TOPIC"),
    DELETE_RESPONSE_EVENT(40, topicName = "LIVELIHOOD_EVENT_TOPIC"),
    RANKING_FLAG_EDIT_NEW(41, topicName = "RANKING_FLAG_EDIT_NEW_TOPIC"),
    DIDI_SHG_FLAG_EDIT_EVENT(42, topicName = "DIDI_SHG_FLAG_EDIT_EVENT_TOPIC"),
    DIDI_ABLE_BODIED_FLAG_EDIT_EVENT(42, topicName = "DIDI_ABLE_BODIED_FLAG_EVENT_TOPIC");
