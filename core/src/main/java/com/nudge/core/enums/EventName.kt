...
enum class EventName(val id: Int, val depends_on: List<Int> = emptyList(), val topicName: String) {
    ...
    SAVE_PAT_ANSWERS(8, listOf(7), topicName = "PAT_SAVE_TOPIC"),
    SAVE_PAT_SCORE(9, listOf(7), topicName = "BENEFICIARY_EDIT_TOPIC"),
    SAVE_VO_ENDORSEMENT(10, listOf(9), topicName = "BENEFICIARY_EDIT_TOPIC"),
