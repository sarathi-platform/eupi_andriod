package com.nudge.core.ui.date_picker_component.datepicker.ui.viewmodel
...
internal class DatePickerViewModel : ViewModel() {
    ...
    fun updateTitleHeader(date: DatePickerDate) {
    ...
    fun getDateForHeader(date: DatePickerDate): String {

        val c = Calendar.getInstance()
        c.set(date.year, date.month, date.day)
        val dateInMillis = c.timeInMillis

        return dateInMillis.getDate()
