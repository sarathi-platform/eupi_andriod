...
object CoreGraph {
    ...
    val HOME = "home_graph/{${CoreNavigationParams.ARG_USER_TYPE.value}}"
    ...
    val BPC_GRAPH = "bpc_graph/{${CoreNavigationParams.ARG_VILLAGE_ID.value}}/{${CoreNavigationParams.ARG_STEP_ID.value}}"
     val MISSION_SUMMARY_GRAPH =
        "mission_summary_graph/{${CoreNavigationParams.ARG_ACTIVITY_ID.value}}/{${CoreNavigationParams.ARG_MISSION_ID.value}}/{${CoreNavigationParams.ARG_ACTIVITY_DATE.value}}/{${CoreNavigationParams.ARG_SURVEY_ID.value}}"
}
...
sealed class BSHomeScreens(val route: String) {
    ...
    object SECTION_SCREEN :
        BSHomeScreens(route = "$SECTION_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_DIDI_ID.value}}/{${CoreNavigationParams.ARG_SURVEY_ID.value}}")

    object QUESTION_SCREEN :
        BSHomeScreens(route = "$QUESTION_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_SECTION_ID.value}}/{${CoreNavigationParams.ARG_DIDI_ID.value}}/{${CoreNavigationParams.ARG_SURVEY_ID.value}}")

    object SURVEYEE_LIST_SCREEN :
        BSHomeScreens(route = "$SURVEYEE_LIST_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_ACTIVITY_ID.value}}")

    object VIDEO_PLAYER_SCREEN :
        BSHomeScreens(route = "$VIDEO_PLAYER_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_VIDEO_PATH.value}}")

    object FormTypeQuestionScreen :
        BSHomeScreens(route = "$FORM_TYPE_QUESTION_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_QUESTION_NAME.value}}/{${CoreNavigationParams.ARG_SURVEY_ID.value}}/{${CoreNavigationParams.ARG_SECTION_ID.value}}/{${CoreNavigationParams.ARG_QUESTION_ID.value}}/{${CoreNavigationParams.ARG_DIDI_ID.value}}?{${CoreNavigationParams.ARG_FORM_QUESTION_RESPONSE_REFERENCE_ID.value}}")

    object BaseLineStartScreen :
        BSHomeScreens(route = "$BASELINE_START_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_DIDI_ID.value}}/{${CoreNavigationParams.ARG_SURVEY_ID.value}}")

    object SearchScreen :
        BSHomeScreens(route = "$SEARCH_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_SURVEY_ID.value}}/{${CoreNavigationParams.ARG_DIDI_ID.value}}/{${CoreNavigationParams.ARG_FROM_SCREEN.value}}")
    ...
    object MISSION_SUMMARY_SCREEN :
        BSHomeScreens(route = "$MISSION_SUMMARY_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_MISSION_ID.value}}/{${CoreNavigationParams.ARG_MISSION_NAME.value}}/{${CoreNavigationParams.ARG_MISSION_DATE.value}}")

    object Final_StepComplitionScreen :
        BSHomeScreens(route = "$Final_Step_Complition_Screen_ROUTE_NAME/{${CoreNavigationParams.ARG_COMPLETION_MESSAGE.value}}")

    object STEP_COMPLETION_SCREEN :
        BSHomeScreens(route = "$Step_Complition_Screen_ROUTE_NAME/{${CoreNavigationParams.ARG_COMPLETION_MESSAGE.value}}")

    object FORM_QUESTION_SUMMARY_SCREEN : BSHomeScreens(
        route = "$FORM_QUESTION_SUMMARY_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_SURVEY_ID.value}}/{${CoreNavigationParams.ARG_SECTION_ID.value}}/{${CoreNavigationParams.ARG_QUESTION_ID.value}}/{${CoreNavigationParams.ARG_DIDI_ID.value}}"
    )
...
sealed class SettingScreens(val route: String) {
    ...
    object VIDEO_PLAYER_SCREEN : SettingScreens(route = "$VIDEO_PLAYER_SCREEN_ROUTE_NAME/{${CoreNavigationParams.ARG_VIDEO_ID.value}}")
    ...
    object PDF_VIEWER : SettingScreens(route = "$PDF_VIEWER_ROUTE_NAME/{${CoreNavigationParams.ARG_FORM_PATH.value}}")
