...
import com.nudge.core.ui.theme.blueLighter
...
fun ComposeCalendar(
    ...
    if (showOnlyMonth && showOnlyYear) {
        ...
        val months = (DateFormatSymbols(Locale.ENGLISH).shortMonths).toList()
