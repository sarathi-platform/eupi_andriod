...
class CustomCalendarModelImpl : CustomCalendarModel {
    ...
    override val firstDayOfWeek: Int = WeekFields.of(Locale.ENGLISH).firstDayOfWeek.value
    ...
    private fun getMonth(firstDayLocalDate: LocalDate): CustomCalendarMonth {
    ...
    private fun CustomCalendarMonth.toLocalDate(): LocalDate {
        return Instant.ofEpochMilli(startUtcTimeMillis).atZone(utcTimeZoneId).toLocalDate()
    }

    private fun CustomCalendarDate.toLocalDate(): LocalDate {
        return LocalDate.of(
            this.year,
            this.month,
            this.dayOfMonth
