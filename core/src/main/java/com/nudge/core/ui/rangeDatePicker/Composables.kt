package com.nudge.core.ui.rangeDatePicker
...
import com.nudge.core.ui.rangeDatePicker.util.between
import com.nudge.core.ui.rangeDatePicker.util.getCalendar
import com.nudge.core.ui.rangeDatePicker.util.getCalendarMonthDays
import com.nudge.core.ui.rangeDatePicker.util.getMonthText
import com.nudge.core.ui.rangeDatePicker.util.sameDay
...
private fun DatePickerHeader(
    ...
    Row(
        ...
        Icon(
            imageVector = Icons.Default.KeyboardArrowLeft, //painterResource(id = R.drawable.ic_calendar_previous),
        ...
        Spacer(modifier = Modifier.weight(1f))
        Icon(
            imageVector = Icons.Default.KeyboardArrowRight, //painterResource(id = R.drawable.ic_calendar_previous),
            contentDescription = null,
            tint = Color.Unspecified,
            modifier = Modifier
                .align(CenterVertically)
