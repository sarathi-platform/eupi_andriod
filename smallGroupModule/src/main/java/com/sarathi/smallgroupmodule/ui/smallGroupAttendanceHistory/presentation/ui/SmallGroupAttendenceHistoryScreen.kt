                            ...
                            smallGroupAttendanceHistoryViewModel.subjectAttendanceHistoryStateMappingByDate.value?.forEach {
                                item {
                                    AttendanceSummaryCard(
                                        ...
                                        subjectAttendanceHistoryStateMappingByDate = it,
                                        onDeleteClicked = {
                                            smallGroupAttendanceHistoryViewModel.onEvent(SmallGroupAttendanceEvent.InitiateDeleteForDateEvent(Pair(smallGroupId, it.key)))
                                            smallGroupAttendanceHistoryViewModel.onEvent(DialogEvents.ShowDialogEvent(true))
                                        },
                                        onEditClicked = {
                                            navController.navigateToAttendanceEditScreen(
                                                smallGroupId,
