...
class FetchAttendanceHistoryForDateFromDbRepositoryImpl @Inject constructor(
    ...
    override suspend fun fetchSmallGroupAttendanceHistoryForDate(
        smallGroupId: Int,
        selectedDate: Long
        ...
        val smallGroupAttendanceHistory =
            fetchSmallGroupHistory(smallGroupId, subjectIds, selectedDate)
    ...
    override suspend fun fetchSmallGroupHistory(
        ...
        return subjectAttributeDao.getSmallGroupAttendanceHistoryForDate(
            uniqueUserId,
            subjectIds,
            dateRange
        )
